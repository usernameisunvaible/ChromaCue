...
module.exports = {
  ...
  init(callback) {
    ...
    httpRequest({
      ...
      "title": "Chroma Cue",
      "description": "link all your devices in a single app",
      "author": {
        "name": "David Benistant",
        "contact": "https://github.com/usernameisunvaible"
      },
      "device_supported": [
        "keyboard",
        "mouse",
  ...
  setEffect(id, callback) {
    ...
    }, JSON.stringify({ id }), callback).then((data) => {
    }).catch(console.error);
  }
};
